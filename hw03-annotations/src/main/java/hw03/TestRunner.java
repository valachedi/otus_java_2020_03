...
public class TestRunner {
    public static void runByClassName(String className) throws Exception {
        ...
        ArrayList<Method> methodsOfBefore = new ArrayList<Method>(50);
        ArrayList<Method> methodsOfTest = new ArrayList<Method>(50);
        ArrayList<Method> methodsOfAfter = new ArrayList<Method>(50);
        ...
        ArrayList failedMethodNames = new ArrayList(10);
